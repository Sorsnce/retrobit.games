...
{
    public partial class UserControl62 : UserControl
    {
        public UserControl62()
        {
            InitializeComponent();
            ...
            using (var client = new WebClient())
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            client.DownloadFile("https://retrobit.games/storage/UserID/" + Login.getName() + "/SAVES/00085.srm", "RetroArch\\saves\\00085.srm");
                        }
                        ...
                        client.DownloadFileCompleted += DownloadCompleted00085;
                        client.DownloadFileAsync(new Uri("https://retrobit.games/storage/UserID/" + Login.getName() + "/ROM/00085.gba"), "RetroArch\\roms\\00085.gba");
                    }
                    catch
                    {
        ...
        void DownloadCompleted00085(object sender, AsyncCompletedEventArgs e)
        {
            Process process = new Process();
            // Configure the process using the StartInfo properties.
            process.StartInfo.FileName = "RetroArch\\retroarch.exe";
            process.StartInfo.Arguments = "-L RetroArch\\cores\\mgba_libretro.dll RetroArch\\roms\\00085.gba";
            process.Start();
            label2.Text = "";
            process.WaitForExit();
            ...
            try
            {
                ...
                Post_File.HttpUploadFile("https://retrobit.games/save.php", @"RetroArch\\saves\\00085.srm", "uploadfile", "application/vnd.ms-excel", nvc);
            }
            catch
            {
            ...
            if (File.Exists(@"RetroArch\\roms\\00085.gba"))
            {
                File.Delete(@"RetroArch\\roms\\00085.gba");
