...
{
    public partial class UserControl43 : UserControl
    {
        public UserControl43()
        {
            InitializeComponent();
            ...
            using (var client = new WebClient())
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        client.DownloadFileCompleted += DownloadCompleted00052;
                        client.DownloadFileAsync(new Uri("https://retrobit.games/storage/UserID/" + Login.getName() + "/ROM/00052.nes"), "RetroArch\\roms\\00052.nes");
                    }
                    catch
                    {
        ...
        void DownloadCompleted00052(object sender, AsyncCompletedEventArgs e)
        {
            Process process = new Process();
            // Configure the process using the StartInfo properties.
            process.StartInfo.FileName = "RetroArch\\retroarch.exe";
            process.StartInfo.Arguments = "-L RetroArch\\cores\\retrobit_nes.dll RetroArch\\roms\\00052.nes";
            process.Start();
            label2.Text = "";
            process.WaitForExit();
            ...
            if (File.Exists(@"RetroArch\\roms\\00052.nes"))
            {
                File.Delete(@"RetroArch\\roms\\00052.nes");
