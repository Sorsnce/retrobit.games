...
{
    public partial class UserControl46 : UserControl
    {
        public UserControl46()
        {
            InitializeComponent();
            ...
            using (var client = new WebClient())
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        client.DownloadFileCompleted += DownloadCompleted00055;
                        client.DownloadFileAsync(new Uri("https://retrobit.games/storage/UserID/" + Login.getName() + "/ROM/00055.nes"), "RetroArch\\roms\\00055.nes");
                    }
                    catch
                    {
        ...
        void DownloadCompleted00055(object sender, AsyncCompletedEventArgs e)
        {
            Process process = new Process();
            // Configure the process using the StartInfo properties.
            process.StartInfo.FileName = "RetroArch\\retroarch.exe";
            process.StartInfo.Arguments = "-L RetroArch\\cores\\retrobit_nes.dll RetroArch\\roms\\00055.nes";
            process.Start();
            label2.Text = "";
            process.WaitForExit();
            ...
            if (File.Exists(@"RetroArch\\roms\\00055.nes"))
            {
                File.Delete(@"RetroArch\\roms\\00055.nes");
