...
{
    public partial class UserControl71 : UserControl
    {
        public UserControl71()
        {
            InitializeComponent();
            ...
            using(var client = new WebClient())
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            client.DownloadFile("https://retrobit.games/storage/UserID/" + Login.getName() + "/SAVES/00071.srm", "RetroArch\\saves\\00071.srm");
                        }
                        ...
                        client.DownloadFileCompleted += DownloadCompleted00071;
                        client.DownloadFileAsync(new Uri("https://retrobit.games/storage/UserID/" + Login.getName() + "/ROM/00071.gbc"), "RetroArch\\roms\\00071.gbc");
                    }
                    catch
                    {
        ...
        void DownloadCompleted00071(object sender, AsyncCompletedEventArgs e)
        {
            Process process = new Process();
            // Configure the process using the StartInfo properties.
            process.StartInfo.FileName = "RetroArch\\retroarch.exe";
            process.StartInfo.Arguments = "-L RetroArch\\cores\\gambatte_libretro.dll RetroArch\\roms\\00071.gbc";
            process.Start();
            label2.Text = "";
            process.WaitForExit();
            ...
            try
            {
                ...
                Post_File.HttpUploadFile("https://retrobit.games/save.php", @"RetroArch\\saves\\00071.srm", "uploadfile", "application/vnd.ms-excel", nvc);
            }
            catch
            {
            ...
            if (File.Exists(@"RetroArch\\roms\\00071.gbc"))
            {
                File.Delete(@"RetroArch\\roms\\00071.gbc");
