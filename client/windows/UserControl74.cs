...
{
    public partial class UserControl74 : UserControl
    {
        public UserControl74()
        {
            InitializeComponent();
            ...
            using (var client = new WebClient())
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            client.DownloadFile("https://retrobit.games/storage/UserID/" + Login.getName() + "/SAVES/00078.srm", "RetroArch\\saves\\00078.srm");
                        }
                        ...
                        client.DownloadFileCompleted += DownloadCompleted00078;
                        client.DownloadFileAsync(new Uri("https://retrobit.games/storage/UserID/" + Login.getName() + "/ROM/00078.gba"), "RetroArch\\roms\\00078.gba");
                    }
                    catch
                    {
        ...
        void DownloadCompleted00078(object sender, AsyncCompletedEventArgs e)
        {
            Process process = new Process();
            // Configure the process using the StartInfo properties.
            process.StartInfo.FileName = "RetroArch\\retroarch.exe";
            process.StartInfo.Arguments = "-L RetroArch\\cores\\mgba_libretro.dll RetroArch\\roms\\00078.gba";
            process.Start();
            label2.Text = "";
            process.WaitForExit();
            ...
            try
            {
                ...
                Post_File.HttpUploadFile("https://retrobit.games/save.php", @"RetroArch\\saves\\00078.srm", "uploadfile", "application/vnd.ms-excel", nvc);
            }
            catch
            {
            ...
            if (File.Exists(@"RetroArch\\roms\\00078.gba"))
            {
                File.Delete(@"RetroArch\\roms\\00078.gba");
