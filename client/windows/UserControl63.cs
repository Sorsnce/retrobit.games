...
{
    public partial class UserControl63 : UserControl
    {
        public UserControl63()
        {
            InitializeComponent();
            ...
            using (var client = new WebClient())
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            client.DownloadFile("https://retrobit.games/storage/UserID/" + Login.getName() + "/SAVES/00075.srm", "RetroArch\\saves\\00075.srm");
                        }
                        ...
                        client.DownloadFileCompleted += DownloadCompleted00075;
                        client.DownloadFileAsync(new Uri("https://retrobit.games/storage/UserID/" + Login.getName() + "/ROM/00075.gbc"), "RetroArch\\roms\\00075.gbc");
                    }
                    catch
                    {
        ...
        void DownloadCompleted00075(object sender, AsyncCompletedEventArgs e)
        {
            Process process = new Process();
            // Configure the process using the StartInfo properties.
            process.StartInfo.FileName = "RetroArch\\retroarch.exe";
            process.StartInfo.Arguments = "-L RetroArch\\cores\\gambatte_libretro.dll RetroArch\\roms\\00075.gbc";
            process.Start();
            label2.Text = "";
            process.WaitForExit();
            ...
            try
            {
                ...
                Post_File.HttpUploadFile("https://retrobit.games/save.php", @"RetroArch\\saves\\00075.srm", "uploadfile", "application/vnd.ms-excel", nvc);
            }
            catch
            {
            ...
            if (File.Exists(@"RetroArch\\roms\\00075.gbc"))
            {
                File.Delete(@"RetroArch\\roms\\00075.gbc");
