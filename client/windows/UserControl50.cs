...
{
    public partial class UserControl50 : UserControl
    {
        public UserControl50()
        {
            InitializeComponent();
            ...
            using (var client = new WebClient())
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        client.DownloadFileCompleted += DownloadCompleted00050;
                        client.DownloadFileAsync(new Uri("https://retrobit.games/storage/UserID/" + Login.getName() + "/ROM/00050.nes"), "RetroArch\\roms\\00050.nes");
                    }
                    catch
                    {
        ...
        void DownloadCompleted00050(object sender, AsyncCompletedEventArgs e)
        {
            Process process = new Process();
            // Configure the process using the StartInfo properties.
            process.StartInfo.FileName = "RetroArch\\retroarch.exe";
            process.StartInfo.Arguments = "-L RetroArch\\cores\\retrobit_nes.dll RetroArch\\roms\\00050.nes";
            process.Start();
            label2.Text = "";
            process.WaitForExit();
            ...
            if (File.Exists(@"RetroArch\\roms\\00050.nes"))
            {
                File.Delete(@"RetroArch\\roms\\00050.nes");
