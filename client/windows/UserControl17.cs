...
namespace Retrobit.Games
{
    public partial class UserControl17 : UserControl
    {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        progressBar1.Visible = true;
                            try
                            {
                                client.DownloadFile("https://retrobit.games/storage/UserID/" + Login.getName() + "/SAVES/00023.srm", "RetroArch\\saves\\00023.srm");
                            }
                        ...
                        client.DownloadFileCompleted += DownloadCompleted0023;
                        client.DownloadFileAsync(new Uri("https://retrobit.games/storage/UserID/" + Login.getName() + "/ROM/00023.n64"), "RetroArch\\roms\\00023.n64");
                    }
                    catch
                    {
        ...
        void DownloadCompleted0023(object sender, AsyncCompletedEventArgs e)
        {
            Process process = new Process();
            // Configure the process using the StartInfo properties.
            process.StartInfo.FileName = "RetroArch\\retroarch.exe";
            process.StartInfo.Arguments = "-L RetroArch\\cores\\parallel_n64_libretro.dll RetroArch\\roms\\00023.n64";
            process.Start();
            //label2.Text = "";
            process.WaitForExit();
            ...
            try
            {
                ...
                Post_File.HttpUploadFile("https://retrobit.games/save.php", @"RetroArch\\saves\\00023.srm", "uploadfile", "application/vnd.ms-excel", nvc);
            }
            catch
            {
            ...
            if (File.Exists(@"RetroArch\\roms\\00023.n64"))
            {
                File.Delete(@"RetroArch\\roms\\00023.n64");
