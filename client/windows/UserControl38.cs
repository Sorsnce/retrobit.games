...
{
    public partial class UserControl38 : UserControl
    {
        public UserControl38()
        {
            InitializeComponent();
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        progressBar1.Visible = true;
                            try
                            {
                                client.DownloadFile("https://retrobit.games/storage/UserID/" + Login.getName() + "/SAVES/00044.srm", "RetroArch\\saves\\00044.srm");
                            }
                        ...
                        client.DownloadFileCompleted += DownloadCompleted00044;
                        client.DownloadFileAsync(new Uri("https://retrobit.games/storage/UserID/" + Login.getName() + "/ROM/00044.smc"), "RetroArch\\roms\\00044.smc");
                    }
                    catch
                    {
        ...
        void DownloadCompleted00044(object sender, AsyncCompletedEventArgs e)
        {
            Process process = new Process();
            // Configure the process using the StartInfo properties.
            process.StartInfo.FileName = "RetroArch\\retroarch.exe";
            process.StartInfo.Arguments = "-L RetroArch\\cores\\snes9x_libretro.dll RetroArch\\roms\\00044.smc";
            process.Start();
            label2.Text = "";
            process.WaitForExit();
            ...
            try
            {
                ...
                Post_File.HttpUploadFile("https://retrobit.games/save.php", @"RetroArch\\saves\\00044.srm", "uploadfile", "application/vnd.ms-excel", nvc);
            }
            catch
            {
            ...
            if (File.Exists(@"RetroArch\\roms\\00044.smc"))
            {
                File.Delete(@"RetroArch\\roms\\00044.smc");
