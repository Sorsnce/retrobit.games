...
{
    public partial class UserControl33 : UserControl
    {
        public UserControl33()
        {
            InitializeComponent();
            ...
            using (var client = new WebClient())
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        client.DownloadFileCompleted += DownloadCompleted00039;
                        client.DownloadFileAsync(new Uri("https://retrobit.games/storage/UserID/" + Login.getName() + "/ROM/00039.smc"), "RetroArch\\roms\\00039.smc");
                    }
                    catch
                    {
        ...
        void DownloadCompleted00039(object sender, AsyncCompletedEventArgs e)
        {
            Process process = new Process();
            // Configure the process using the StartInfo properties.
            process.StartInfo.FileName = "RetroArch\\retroarch.exe";
            process.StartInfo.Arguments = "-L RetroArch\\cores\\snes9x_libretro.dll RetroArch\\roms\\00039.smc";
            process.Start();
            label2.Text = "";
            process.WaitForExit();
            ...
            if (File.Exists(@"RetroArch\\roms\\00039.smc"))
            {
                File.Delete(@"RetroArch\\roms\\00039.smc");
