...
{
    public partial class UserControl72 : UserControl
    {
        public UserControl72()
        {
            InitializeComponent();
            ...
            using (var client = new WebClient())
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            client.DownloadFile("https://retrobit.games/storage/UserID/" + Login.getName() + "/SAVES/00084.srm", "RetroArch\\saves\\00084.srm");
                        }
                        ...
                        client.DownloadFileCompleted += DownloadCompleted00084;
                        client.DownloadFileAsync(new Uri("https://retrobit.games/storage/UserID/" + Login.getName() + "/ROM/00084.gba"), "RetroArch\\roms\\00084.gba");
                    }
                    catch
                    {
        ...
        void DownloadCompleted00084(object sender, AsyncCompletedEventArgs e)
        {
            Process process = new Process();
            // Configure the process using the StartInfo properties.
            process.StartInfo.FileName = "RetroArch\\retroarch.exe";
            process.StartInfo.Arguments = "-L RetroArch\\cores\\mgba_libretro.dll RetroArch\\roms\\00084.gba";
            process.Start();
            label2.Text = "";
            process.WaitForExit();
            ...
            try
            {
                ...
                Post_File.HttpUploadFile("https://retrobit.games/save.php", @"RetroArch\\saves\\00084.srm", "uploadfile", "application/vnd.ms-excel", nvc);
            }
            catch
            {
            ...
            if (File.Exists(@"RetroArch\\roms\\00084.gba"))
            {
                File.Delete(@"RetroArch\\roms\\00084.gba");
