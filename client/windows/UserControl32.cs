...
{
    public partial class UserControl32 : UserControl
    {
        public UserControl32()
        {
            InitializeComponent();
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        progressBar1.Visible = true;
                            try
                            {
                                client.DownloadFile("https://retrobit.games/storage/UserID/" + Login.getName() + "/SAVES/00038.srm", "RetroArch\\saves\\00038.srm");
                            }
                        ...
                        client.DownloadFileCompleted += DownloadCompleted00038;
                        client.DownloadFileAsync(new Uri("https://retrobit.games/storage/UserID/" + Login.getName() + "/ROM/00038.smc"), "RetroArch\\roms\\00038.smc");
                    }
                    catch
                    {
        ...
        void DownloadCompleted00038(object sender, AsyncCompletedEventArgs e)
        {
            Process process = new Process();
            // Configure the process using the StartInfo properties.
            process.StartInfo.FileName = "RetroArch\\retroarch.exe";
            process.StartInfo.Arguments = "-L RetroArch\\cores\\snes9x_libretro.dll RetroArch\\roms\\00038.smc";
            process.Start();
            label2.Text = "";
            process.WaitForExit();
            ...
            try
            {
                ...
                Post_File.HttpUploadFile("https://retrobit.games/save.php", @"RetroArch\\saves\\00038.srm", "uploadfile", "application/vnd.ms-excel", nvc);
            }
            catch
            {
            ...
            if (File.Exists(@"RetroArch\\roms\\00038.smc"))
            {
                File.Delete(@"RetroArch\\roms\\00038.smc");
