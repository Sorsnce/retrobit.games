...
{
    public partial class UserControl75 : UserControl
    {
        public UserControl75()
        {
            InitializeComponent();
            ...
            using (var client = new WebClient())
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            client.DownloadFile("https://retrobit.games/storage/UserID/" + Login.getName() + "/SAVES/00083.srm", "RetroArch\\saves\\00083.srm");
                        }
                        ...
                        client.DownloadFileCompleted += DownloadCompleted00083;
                        client.DownloadFileAsync(new Uri("https://retrobit.games/storage/UserID/" + Login.getName() + "/ROM/00083.gba"), "RetroArch\\roms\\00083.gba");
                    }
                    catch
                    {
        ...
        void DownloadCompleted00083(object sender, AsyncCompletedEventArgs e)
        {
            Process process = new Process();
            // Configure the process using the StartInfo properties.
            process.StartInfo.FileName = "RetroArch\\retroarch.exe";
            process.StartInfo.Arguments = "-L RetroArch\\cores\\mgba_libretro.dll RetroArch\\roms\\00083.gba";
            process.Start();
            label2.Text = "";
            process.WaitForExit();
            ...
            try
            {
                ...
                Post_File.HttpUploadFile("https://retrobit.games/save.php", @"RetroArch\\saves\\00083.srm", "uploadfile", "application/vnd.ms-excel", nvc);
            }
            catch
            {
            ...
            if (File.Exists(@"RetroArch\\roms\\00083.gba"))
            {
                File.Delete(@"RetroArch\\roms\\00083.gba");
