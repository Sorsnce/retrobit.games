...
{
    public partial class UserControl37 : UserControl
    {
        public UserControl37()
        {
            InitializeComponent();
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        progressBar1.Visible = true;
                            try
                            {
                                client.DownloadFile("https://retrobit.games/storage/UserID/" + Login.getName() + "/SAVES/00043.srm", "RetroArch\\saves\\00043.srm");
                            }
                        ...
                        client.DownloadFileCompleted += DownloadCompleted00043;
                        client.DownloadFileAsync(new Uri("https://retrobit.games/storage/UserID/" + Login.getName() + "/ROM/00043.smc"), "RetroArch\\roms\\00043.smc");
                    }
                    catch
                    {
        ...
        void DownloadCompleted00043(object sender, AsyncCompletedEventArgs e)
        {
            Process process = new Process();
            // Configure the process using the StartInfo properties.
            process.StartInfo.FileName = "RetroArch\\retroarch.exe";
            process.StartInfo.Arguments = "-L RetroArch\\cores\\snes9x_libretro.dll RetroArch\\roms\\00043.smc";
            process.Start();
            label2.Text = "";
            process.WaitForExit();
            ...
            try
            {
                ...
                Post_File.HttpUploadFile("https://retrobit.games/save.php", @"RetroArch\\saves\\00043.srm", "uploadfile", "application/vnd.ms-excel", nvc);
            }
            catch
            {
            ...
            if (File.Exists(@"RetroArch\\roms\\00043.smc"))
            {
                File.Delete(@"RetroArch\\roms\\00043.smc");
