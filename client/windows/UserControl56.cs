...
{
    public partial class UserControl56 : UserControl
    {
        public UserControl56()
        {
            InitializeComponent();
            ...
            using (var client = new WebClient())
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        client.DownloadFileCompleted += DownloadCompleted00068;
                        client.DownloadFileAsync(new Uri("https://retrobit.games/storage/UserID/" + Login.getName() + "/ROM/00068.nes"), "RetroArch\\roms\\00068.nes");
                    }
                    catch
                    {
        ...
        void DownloadCompleted00068(object sender, AsyncCompletedEventArgs e)
        {
            Process process = new Process();
            // Configure the process using the StartInfo properties.
            process.StartInfo.FileName = "RetroArch\\retroarch.exe";
            process.StartInfo.Arguments = "-L RetroArch\\cores\\retrobit_nes.dll RetroArch\\roms\\00068.nes";
            process.Start();
            label2.Text = "";
            process.WaitForExit();
            ...
            if (File.Exists(@"RetroArch\\roms\\00068.nes"))
            {
                File.Delete(@"RetroArch\\roms\\00068.nes");
