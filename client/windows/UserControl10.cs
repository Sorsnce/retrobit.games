...
namespace Retrobit.Games
{
    public partial class UserControl10 : UserControl
    {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        progressBar1.Visible = true;
                            try
                            {
                                client.DownloadFile("https://retrobit.games/storage/UserID/" + Login.getName() + "/SAVES/00003.srm", "RetroArch\\saves\\00003.srm");
                            }
                        ...
                        client.DownloadFileCompleted += DownloadCompleted0003;
                        client.DownloadFileAsync(new Uri("https://retrobit.games/storage/UserID/" + Login.getName() + "/ROM/00003.n64"), "RetroArch\\roms\\00003.n64");
        ...
        void DownloadCompleted0003(object sender, AsyncCompletedEventArgs e)
        {
            string ROMState = "00003.state";
            Process process = new Process();
            // Configure the process using the StartInfo properties.
            process.StartInfo.FileName = "RetroArch\\retroarch.exe";
            process.StartInfo.Arguments = "-L RetroArch\\cores\\parallel_n64_libretro.dll RetroArch\\roms\\00003.n64";
            process.Start();
            //label2.Text = "";
            process.WaitForExit();
            ...
            try
            {
                ...
                Post_File.HttpUploadFile("https://retrobit.games/save.php", @"RetroArch\\saves\\00003.srm", "uploadfile", "application/vnd.ms-excel", nvc);
            }
            catch
            {
            ...
            if (File.Exists(@"RetroArch\\roms\\00003.n64"))
            {
                File.Delete(@"RetroArch\\roms\\00003.n64");
