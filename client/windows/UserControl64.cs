...
{
    public partial class UserControl64 : UserControl
    {
        public UserControl64()
        {
            InitializeComponent();
            ...
            using (var client = new WebClient())
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            client.DownloadFile("https://retrobit.games/storage/UserID/" + Login.getName() + "/SAVES/00070.srm", "RetroArch\\saves\\00070.srm");
                        }
                        ...
                        client.DownloadFileCompleted += DownloadCompleted00070;
                        client.DownloadFileAsync(new Uri("https://retrobit.games/storage/UserID/" + Login.getName() + "/ROM/00070.gbc"), "RetroArch\\roms\\00070.gbc");
                    }
                    catch
                    {
        ...
        void DownloadCompleted00070(object sender, AsyncCompletedEventArgs e)
        {
            Process process = new Process();
            // Configure the process using the StartInfo properties.
            process.StartInfo.FileName = "RetroArch\\retroarch.exe";
            process.StartInfo.Arguments = "-L RetroArch\\cores\\gambatte_libretro.dll RetroArch\\roms\\00070.gbc";
            process.Start();
            label2.Text = "";
            process.WaitForExit();
            ...
            try
            {
                ...
                Post_File.HttpUploadFile("https://retrobit.games/save.php", @"RetroArch\\saves\\00070.srm", "uploadfile", "application/vnd.ms-excel", nvc);
            }
            catch
            {
            ...
            if (File.Exists(@"RetroArch\\roms\\00070.gbc"))
            {
                File.Delete(@"RetroArch\\roms\\00070.gbc");
