...
{
    public partial class UserControl41 : UserControl
    {
        public UserControl41()
        {
            InitializeComponent();
            ...
            using (var client = new WebClient())
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            client.DownloadFile("https://retrobit.games/storage/UserID/" + Login.getName() + "/SAVES/00067.srm", "RetroArch\\saves\\00067.srm");
                        }
                        ...
                        client.DownloadFileCompleted += DownloadCompleted00067;
                        client.DownloadFileAsync(new Uri("https://retrobit.games/storage/UserID/" + Login.getName() + "/ROM/00067.nes"), "RetroArch\\roms\\00067.nes");
                    }
                    catch
                    {
        ...
        void DownloadCompleted00067(object sender, AsyncCompletedEventArgs e)
        {
            Process process = new Process();
            // Configure the process using the StartInfo properties.
            process.StartInfo.FileName = "RetroArch\\retroarch.exe";
            process.StartInfo.Arguments = "-L RetroArch\\cores\\retrobit_nes.dll RetroArch\\roms\\00067.nes";
            process.Start();
            label2.Text = "";
            process.WaitForExit();
            ...
            try
            {
                ...
                Post_File.HttpUploadFile("https://retrobit.games/save.php", @"RetroArch\\saves\\00067.srm", "uploadfile", "application/vnd.ms-excel", nvc);
            }
            catch
            {
            ...
            if (File.Exists(@"RetroArch\\roms\\00067.nes"))
            {
                File.Delete(@"RetroArch\\roms\\00067.nes");
