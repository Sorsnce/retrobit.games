...
namespace Retrobit.Games
{
    public partial class UserControl25 : UserControl
    {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        progressBar1.Visible = true;
                            try
                            {
                                client.DownloadFile("https://retrobit.games/storage/UserID/" + Login.getName() + "/SAVES/00032.srm", "RetroArch\\saves\\00032.srm");
                            }
                        ...
                        client.DownloadFileCompleted += DownloadCompleted00032;
                        client.DownloadFileAsync(new Uri("https://retrobit.games/storage/UserID/" + Login.getName() + "/ROM/00032.smc"), "RetroArch\\roms\\00032.smc");
                    }
                    catch
                    {
        ...
        void DownloadCompleted00032(object sender, AsyncCompletedEventArgs e)
        {
            Process process = new Process();
            // Configure the process using the StartInfo properties.
            process.StartInfo.FileName = "RetroArch\\retroarch.exe";
            process.StartInfo.Arguments = "-L RetroArch\\cores\\snes9x_libretro.dll RetroArch\\roms\\00032.smc";
            process.Start();
            label2.Text = "";
            process.WaitForExit();
            ...
            try
            {
                ...
                Post_File.HttpUploadFile("https://retrobit.games/save.php", @"RetroArch\\saves\\00032.srm", "uploadfile", "application/vnd.ms-excel", nvc);
            }
            catch
            {
            ...
            if (File.Exists(@"RetroArch\\roms\\00032.smc"))
            {
                File.Delete(@"RetroArch\\roms\\00032.smc");
